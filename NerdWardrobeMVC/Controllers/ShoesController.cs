...
namespace NerdWardrobeMVC.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoesID,ShoeName,ShoeType,ShoeColor,ShoePhoto,OccassionID,SeasonID")] Sho sho)
        {
            ...
            ViewBag.OccassionID = new SelectList(db.Occassions, "OccassionID", "OccassionName", sho.OccassionID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoesID,ShoeName,ShoeType,ShoeColor,ShoePhoto,OccassionID,SeasonID")] Sho sho)
        {
            if (ModelState.IsValid)
            {
